...
import 'package:fyp/podo/foodmgmt/food_menu_response.dart';
...
class AddFoodScreen extends StatefulWidget {
  ...
  AddFoodScreen({Key? key, this.foodMenu}) : super(key: key);
                  ...
                  onPressed: !isAllFilled()
                      ...
                      : () async {
                          if (_formKey.currentState!.validate()) {
                            List<String> values = _foodMenuItemsController
                                .map((controller) => controller.text)
                                .toList();

                            FoodMenuResponse response = FoodMenuResponse(
                                id: _foodIdController.text.isEmpty
                                    ? null
                                    : int.parse(_foodIdController.text),
                                name: _foodNameController.text,
                                cost: double.parse(_foodCostController.text),
                                isPackage: _foodMenuItemsController.isEmpty
                                    ? false
                                    : true,
